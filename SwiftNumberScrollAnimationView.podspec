#
# Be sure to run `pod lib lint SwiftNumberScrollAnimationView.podspec' to ensure this is a
...
SwiftNumberScrollAnimationView.数字跳动动画
  ...
  s.source_files = 'SwiftNumberScrollAnimationView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SwiftNumberScrollAnimationView' => ['SwiftNumberScrollAnimationView/Assets/*.png']
  # }
